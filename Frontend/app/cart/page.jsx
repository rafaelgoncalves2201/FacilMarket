                ...
                {Object.keys(cartItems).map((itemId) => {
                  ...
                  return (
                    <tr key={itemId}>
                      ...
                      <td className="py-4 md:px-4 px-1 text-gray-600">R${product.offerPrice}</td>
                      ...
                      <td className="py-4 md:px-4 px-1 text-gray-600">R${(product.offerPrice * cartItems[itemId]).toFixed(2)}</td>
                    </tr>
                  );
                })}
              </tbody>
